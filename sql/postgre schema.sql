...
GRANT
ALL
ON SCHEMA resort TO pg_database_owner;
...
GRANT
ALL
ON TABLE resort.beds TO postgres;
...
GRANT
ALL
ON TABLE resort.floor TO postgres;
...
GRANT
ALL
ON TABLE resort.gender TO postgres;
...
GRANT
ALL
ON TABLE resort.paymentstatus TO postgres;
...
GRANT
ALL
ON TABLE resort.paymenttype TO postgres;
...
GRANT
ALL
ON TABLE resort.photo TO postgres;
...
GRANT
ALL
ON TABLE resort.resortclass TO postgres;
...
GRANT
ALL
ON TABLE resort.resorttype TO postgres;
...
GRANT
ALL
ON TABLE resort."role_resortASU" TO postgres;
...
GRANT
ALL
ON TABLE resort.services TO postgres;
...
GRANT
ALL
ON TABLE resort.suitclass TO postgres;
...
GRANT
ALL
ON TABLE resort.suitstatus TO postgres;
...
GRANT
ALL
ON TABLE resort."user_resortASU" TO postgres;
...
GRANT
ALL
ON TABLE resort.customer TO postgres;
...
GRANT
ALL
ON TABLE resort.reserve TO postgres;
...
GRANT
ALL
ON TABLE resort.resort TO postgres;
...
GRANT
ALL
ON TABLE resort.suittype TO postgres;
...
GRANT
ALL
ON TABLE resort.userrole TO postgres;
...
GRANT
ALL
ON TABLE resort.building TO postgres;
...
GRANT
ALL
ON TABLE resort.customerreserve TO postgres;
...
GRANT
ALL
ON TABLE resort.suitservices TO postgres;
...
ALTER TABLE resort.buildingfloor OWNER TO postgres;
GRANT
ALL
ON TABLE resort.buildingfloor TO postgres;
...
GRANT
ALL
ON TABLE resort.suit TO postgres;
...
GRANT
ALL
ON TABLE resort.reservesuit TO postgres;
...
CREATE INDEX reserveservices_reserve_idx ON resort.reserveservices USING btree (reservesuit, service);
...
GRANT
ALL
ON TABLE resort.reserveservices TO postgres;